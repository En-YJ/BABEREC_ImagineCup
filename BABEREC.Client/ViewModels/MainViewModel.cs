...
using BABEREC.Client.Helpers;
using BABEREC.Client.Models;    
using Microsoft.Bot.Connector.DirectLine;
using Newtonsoft.Json;
using Reactive.Bindings.Extensions;
using WebSocketSharp;
using BABEREC.Client.Core.Helpers;
using System.Net.Http;

namespace BABEREC.Client.ViewModels
{
    /// <summary>
    /// 메인 페이지 뷰 모델
    /// </summary>
    public class MainViewModel : BindableBase
    {
        ...
        ///     다이렉트 라인 시크릿
        /// </summary>
        private const string DIRECT_LINE_SECRET = "U-fEAKMnvVE.oOyHEZIhPmreTVfkiC_7hPs7lQidhGtAhsb984lHpWI";
        private const string SRGS_FILE_NAME = "SRGS.xml";

        private readonly string _botId = "BABERECBotChannel";

        private readonly CompositeDisposable _compositeDisposable = new CompositeDisposable();
        private readonly string _fromUser = "BABE1004";
